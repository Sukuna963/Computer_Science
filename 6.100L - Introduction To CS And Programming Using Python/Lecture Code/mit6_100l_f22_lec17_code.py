...
print(car1.get_number_occupants())
...
v1 = Vehicle(4,2,'blue')
print(v1.get_number_occupants())   # prints 2
print(v1.add_occupants(3))   # prints 5
print(v1.get_number_occupants())
...
class Vehicle:
    ...
    def add_occupants(self, n):
        ...
        if self.number_occupants <= self.max_occupancy:
            return self.number_occupants
        else:
            raise("occupants exceeds the max_occupancy")
...
v1 = Vehicle(4,2,'blue')
print(v1.get_number_occupants())   # prints 2
print(v1.add_occupants(4))   # prints 5
print(v1.get_number_occupants())
...
v1 = Vehicle(4,2)
print(v1.get_number_occupants())   # prints 2
print(v1.add_occupants(2))   # prints 5
print(v1.get_number_occupants())
print(v1.get_color())
